...
return [
    ...
    */
    'user_models' => [
        'users' => \App\Modules\Users\Models\User::class,
    ],
    ...
    */
    'models' => [
         ...
         * Role model
         */
        'role' => \App\Modules\Rbac\Models\Role::class,

        /**
         * Permission model
         */
        'permission' => \App\Modules\Rbac\Models\Permission::class,

        /**
         * Team model
         */
        'team' => \App\Modules\Rbac\Models\Team::class,
