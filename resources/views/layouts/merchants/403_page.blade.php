...
@section('title', __('store.403_page.title'))
    ...
    <div class="main-shop">
        ...
        <div class="main-shop-wrapper error-page">
            <div class="error-page__wrapper container">
                <h1 class="error-page__title">{{ __('store.403_page.error') }}</h1>
                <div class="error-page__fig">
                    ...
                    <style type="text/css">
                        ...
                        <text transform="matrix(0.8358 0 0 1 515 292.7852)" class="st0 st1 st3">3</text>
                </svg>
                </div>
                <p class="error-page__txt">
                    {{ __('store.403_page.description_first') }}<br />
                    {{ __('store.403_page.description_second') }}
                    <a href="{{ route('products.index') }}">{{ __('store.403_page.url_text') }}</a>
                </p>
            </div>
        </div><!-- /. main wrapper -->
    </div><!-- /. end main -->
