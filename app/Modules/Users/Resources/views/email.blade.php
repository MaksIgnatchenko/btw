    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600"
        ...
        <tr>
            <td style="padding: 20px 0; text-align: center">
                <img src="{{URL::to('/pictures/logo.png')}}"
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600"
        ...
        <tr>
            <td bgcolor="#ffffff" align="center">
                <img src="{{URL::to('/pictures/screen.png')}}"
                     width="600"
                     height=""
                     alt="alt_text"
                     border="0"
                     align="center"
                     style="width: 100%; max-width: 600px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; margin: auto;"
                     class="g-img">
            </td>
        </tr>
        ...
        <tr>
            <td bgcolor="#ffffff"
                style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: center;">
                <p style="margin: 0;">
                    {{-- Intro Lines --}}
        ...
        <tr>
            <td bgcolor="#ffffff"
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center"
                       style="margin: auto">
                    <tr>
                        <td style="border-radius: 3px; background: #222222; text-align: center; padding: 10px"
                            class="button-td">
        ...
        <tr>
            ...
            <td background="https://placehold.it/600x230/222222/666666" bgcolor="#222222" valign="middle"
