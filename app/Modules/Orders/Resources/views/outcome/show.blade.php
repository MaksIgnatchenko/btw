...
@section('content')
    <section class="content-header">
        ...
        {{ Breadcrumbs::render('outcome-payment', $outcome) }}

    </section>

    <div class="content">
        {!! Form::model($outcome, ['route' => ['outcome.update', $outcome->id], 'method' => 'put' , 'class' => 'form-horizontal']) !!}
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('payment_type', PaymentOptionsEnum::toArray(), $outcome->payment_type, ['class' => 'form-control'])!!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('merchant_id', $merchantsFormatted->toArray(), $outcome->merchant_id, [
                                'class' => 'form-control',
                                'disabled' => $editableMerchant? '' : 'disabled'
                                ])!!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('amount', $outcome->amount, ['class' => 'form-control'])!!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::number('fee', null, ['class' => 'form-control', 'step' => '0.01', 'min' => 0, 'max' => 100])!!}
                                @if ($errors->has('fee'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::number('net_amount', null, ['class' => 'form-control', 'readonly' => 'readonly'])!!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('payment_date', DateConverter::date($outcome->payment_date), ['class' => 'form-control'])!!}
