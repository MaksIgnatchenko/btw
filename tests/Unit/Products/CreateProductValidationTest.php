...
class CreateProductValidationTest extends TestCase
{
    ...
    public function testEmptyFields()
    {
        ...
        $rules = (new SetProductRequest())->rules();
    ...
    public function testLocalDeliveryWrong()
    {
        $data = [
            'local_delivery' => true,
            'local_delivery_distance' => '1000',
        ];
        $rules = (new SetProductRequest())->rules();
        ...
        $this->assertEmpty($errors->get('local_delivery'));
        $this->assertEquals($errors->get('local_delivery_distance')[0], 'The local delivery distance may not be greater than 999.');
    }
    ...
    public function testTempLocalDeliveryWithoutMiles()
    {
        $data = [
            'local_delivery' => true,
        ];
