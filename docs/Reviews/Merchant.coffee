###
@api {post} /api/review/merchant Create merchant review
@apiName Create merchant review
@apiDescription Create merchant review. Only for active customers
@apiGroup Review
@apiVersion 0.1.0

@apiParam {String} review Required. Max 500 symbols
@apiParam {Integer} rate Required. From 1 to 5
